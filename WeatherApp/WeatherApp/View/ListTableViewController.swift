...
//  WeatherApp
//
//  Created by Victor Kimpel on 4.08.22.
//
...
class ListTableViewController: UITableViewController {
    ...
    var nameCitiesArray = ["Брест", "Витебск", "Гомель", "Гродно", "Могилёв", "Минск", "Вроцлав"]
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundView = UIImageView(image: #imageLiteral(resourceName: "weatherImg"))
